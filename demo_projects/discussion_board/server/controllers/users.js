...
function UserController(){
	...
	this.login = function(req, res) {
		...
		// if the client did not put any username, store empty ""
		if (req.body.username == undefined) {
			username = "";
		}
		else { // else store username from the form
			username = req.body.username;
		}

		// lowercase the username. This will be used to check the validations
